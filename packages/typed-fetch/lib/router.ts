...
export interface TypedRouteContext <T extends FetchSchema<any>, C extends object> {
...
type ExtractRouterSchema <T extends TypedRouteContext<any, any>> = T extends TypedRouteContext<infer U, any> ? U : never;
...
export type InferRouterSchema <T extends Record<string, TypedRouteContext<any, any>>> = RemoveNever<{
	[K in keyof T]: T[K] extends TypedRouteContext<any, any> ? FetchSchema<{
